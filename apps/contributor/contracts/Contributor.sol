...
contract Contributor is AragonApp {
  ...
  function addContributor(address account, bytes32 hashDigest, uint8 hashFunction, uint8 hashSize, bool isCore) public isInitialized auth(MANAGE_CONTRIBUTORS_ROLE) {
